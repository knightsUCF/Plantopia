...
public class BaseItemScript : MonoBehaviour
{
    ...
    public void GetPositionX() // PK 
    {
        // return (int)this.GetPosition().x; - BaseItemScript does not contain a definition for "GetPosition" and no ac cessible extension method GetPosition
    }

    // public int GetPositionZ()
    public void GetPositionZ() // PK
    {
